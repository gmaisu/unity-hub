  ...
  return (
    <Container>
      {isMobile ? (
        <>
          <TextContainer>
            <MobileTitle>Ostanite u kontaktu</MobileTitle>
            <hr style={{ border: "1px solid", marginBottom: "40px" }} />
            <p>
              Obratite nam se da se raspitate ili rezervišete sastanak.
              Jednostavno popunite obrazac za upit ili nas pozovite.
            </p>
